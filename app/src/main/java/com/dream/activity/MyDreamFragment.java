...
public class MyDreamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup group = (ViewGroup) inflater.inflate(R.layout.fragment_my_dream, container, false);
        group.findViewById(R.id.bt_create_dream).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(),CreateDream1Activity.class);
